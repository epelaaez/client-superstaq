...
# Read in dev requirements, installed with 'python3 -m pip install cirq-superstaq[dev]'
dev_requirements = open("dev-requirements.txt").readlines()
dev_requirements = [r.strip() for r in dev_requirements]

# Read in example requirements, installed with 'python3 -m pip install cirq-superstaq[examples]'
